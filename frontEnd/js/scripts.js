...
document.addEventListener('DOMContentLoaded', function () {
    ...
    calculateButton.addEventListener('click', function() {
        ...
        const necessaryExpenses = document.getElementById('necessaryExpenses').value || 0;
        ...
        const comprehensiveIncomeNum = parseFloat(comprehensiveIncome.replace(/,/g, ''));
        const necessaryExpensesNum = parseFloat(necessaryExpenses.replace(/,/g, ''));
        const deductionNum = parseFloat(deduction.replace(/,/g, ''));
        const taxCreditNum = parseFloat(taxCredit.replace(/,/g, ''));

        // 결과 출력 필드
        const rComprehensiveIncome = document.getElementById('rComprehensiveIncome');
        ...
        function calculateTaxRate(income) {
            ...
            else if (income <= 150000000) return 15360000 + (income - 88000000) * 0.34;
